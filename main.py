...
def get_jobs(keyword, num_jobs, verbose,slp_time):
    ...
    chrome_executable= Service(executable_path="C:/Users/HP/ds_salary_proj/chromedriver",log_path='NUL')
    driver = webdriver.Chrome(
        executable_path="C:/Users/HP/ds_salary_proj/chromedriver", options=options)
